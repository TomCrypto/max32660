...
#[doc = "Field `DATA` reader - This register is used for the SPI0 transmit and receive FIFO."]
pub type DATA_R = crate::FieldReader<u32>;
#[doc = "Field `DATA` writer - This register is used for the SPI0 transmit and receive FIFO."]
pub type DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - This register is used for the SPI0 transmit and receive FIFO."]
    #[inline(always)]
