...
#[doc = "Output level set for pin 0.\n\nValue on reset: 0"]
...
#[doc = "Field `p0` writer - Output level set for pin 0."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P0_AW::HIGH)
    }
}
#[doc = "Output level set for pin 1.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P1_AW {
...
#[doc = "Field `p1` writer - Output level set for pin 1."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P1_AW::HIGH)
    }
}
#[doc = "Output level set for pin 2.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P2_AW {
...
#[doc = "Field `p2` writer - Output level set for pin 2."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P2_AW::HIGH)
    }
}
#[doc = "Output level set for pin 3.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P3_AW {
...
#[doc = "Field `p3` writer - Output level set for pin 3."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P3_AW::HIGH)
    }
}
#[doc = "Output level set for pin 4.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P4_AW {
...
#[doc = "Field `p4` writer - Output level set for pin 4."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P4_AW::HIGH)
    }
}
#[doc = "Output level set for pin 5.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P5_AW {
...
#[doc = "Field `p5` writer - Output level set for pin 5."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P5_AW::HIGH)
    }
}
#[doc = "Output level set for pin 6.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P6_AW {
...
#[doc = "Field `p6` writer - Output level set for pin 6."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P6_AW::HIGH)
    }
}
#[doc = "Output level set for pin 7.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P7_AW {
...
#[doc = "Field `p7` writer - Output level set for pin 7."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P7_AW::HIGH)
    }
}
#[doc = "Output level set for pin 8.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P8_AW {
...
#[doc = "Field `p8` writer - Output level set for pin 8."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P8_AW::HIGH)
    }
}
#[doc = "Output level set for pin 9.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P9_AW {
...
#[doc = "Field `p9` writer - Output level set for pin 9."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P9_AW::HIGH)
    }
}
#[doc = "Output level set for pin 10.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P10_AW {
...
#[doc = "Field `p10` writer - Output level set for pin 10."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P10_AW::HIGH)
    }
}
#[doc = "Output level set for pin 11.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P11_AW {
...
#[doc = "Field `p11` writer - Output level set for pin 11."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P11_AW::HIGH)
    }
}
#[doc = "Output level set for pin 12.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P12_AW {
...
#[doc = "Field `p12` writer - Output level set for pin 12."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P12_AW::HIGH)
    }
}
#[doc = "Output level set for pin 13.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum P13_AW {
...
#[doc = "Field `p13` writer - Output level set for pin 13."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(P13_AW::HIGH)
    }
}
impl W {
    #[doc = "Bit 0 - Output level set for pin 0."]
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<OUT_SET_SPEC, 0> {
        P0_W::new(self)
    }
    #[doc = "Bit 1 - Output level set for pin 1."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<OUT_SET_SPEC, 1> {
        P1_W::new(self)
    }
    #[doc = "Bit 2 - Output level set for pin 2."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<OUT_SET_SPEC, 2> {
        P2_W::new(self)
    }
    #[doc = "Bit 3 - Output level set for pin 3."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<OUT_SET_SPEC, 3> {
        P3_W::new(self)
    }
    #[doc = "Bit 4 - Output level set for pin 4."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<OUT_SET_SPEC, 4> {
        P4_W::new(self)
    }
    #[doc = "Bit 5 - Output level set for pin 5."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<OUT_SET_SPEC, 5> {
        P5_W::new(self)
    }
    #[doc = "Bit 6 - Output level set for pin 6."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<OUT_SET_SPEC, 6> {
        P6_W::new(self)
    }
    #[doc = "Bit 7 - Output level set for pin 7."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<OUT_SET_SPEC, 7> {
        P7_W::new(self)
    }
    #[doc = "Bit 8 - Output level set for pin 8."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8_W<OUT_SET_SPEC, 8> {
        P8_W::new(self)
    }
    #[doc = "Bit 9 - Output level set for pin 9."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9_W<OUT_SET_SPEC, 9> {
        P9_W::new(self)
    }
    #[doc = "Bit 10 - Output level set for pin 10."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10_W<OUT_SET_SPEC, 10> {
        P10_W::new(self)
    }
    #[doc = "Bit 11 - Output level set for pin 11."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11_W<OUT_SET_SPEC, 11> {
        P11_W::new(self)
    }
    #[doc = "Bit 12 - Output level set for pin 12."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12_W<OUT_SET_SPEC, 12> {
        P12_W::new(self)
    }
    #[doc = "Bit 13 - Output level set for pin 13."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13_W<OUT_SET_SPEC, 13> {
        P13_W::new(self)
    }
