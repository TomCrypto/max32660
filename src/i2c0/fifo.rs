...
#[doc = "Field `DATA` reader - Data is read from or written to this location."]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - Data is read from or written to this location."]
pub type DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Data is read from or written to this location."]
    #[inline(always)]
