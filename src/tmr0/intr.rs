...
#[doc = "Field `IRQ` reader - Interrupt Flag for Timer A."]
pub type IRQ_R = crate::BitReader;
#[doc = "Field `IRQ` writer - Interrupt Flag for Timer A."]
pub type IRQ_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irq(&mut self) -> IRQ_W<INTR_SPEC, 0> {
        IRQ_W::new(self)
    }
